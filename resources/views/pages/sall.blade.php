...
<body>
            ...
            <div class="container-fluid">
                ...
                <a class="navbar-brand py-lg-2 mb-lg-5 px-lg-6 me-0" href="#">
                    <h3 class="text-success"><img src="./img/youdemy-logo.png" width="40"><span
                            class="text-info">resr</span>vation</h3>
                </a>
                <!-- User menu (mobile) -->
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <a href="#" class="btn d-inline-flex btn-sm btn-warning mx-1"
                                                ...
                                                data-id="<?= htmlspecialchars($salle->id) ?>"
                                                data-name="<?= htmlspecialchars($salle->name) ?>"
                                                data-description="<?= htmlspecialchars($salle->description) ?>"
                                                data-location="<?= htmlspecialchars($salle->location) ?>"
                                                data-photo="<?= htmlspecialchars($salle->photo) ?>">
                                                <span class="pe-2">
                                            ...
                                            <form action="{{ route('sall.delete', $salle->id) }}" method="POST"
    ...
    <div class="modal fade" id="editCourseModal" tabindex="-1" aria-labelledby="editCourseModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('sall.update', ['id' => $salle->id]) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="sall_id" id="sall_id">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="location" class="form-control" id="edilocation" required>
                        </div>
    ...
    <script>
        function loadSallData(element) {
            document.getElementById('sall_id').value = element.getAttribute('data-id');
            ...
            document.getElementById('edilocation').value = element.getAttribute('data-location');
